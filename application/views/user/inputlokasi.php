...
<head>
    ...
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCr5dE6Rz99tbJzGSw5CaKIDXbT6Vvnzao&libraries=places"></script>
...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <br>
            <input class="form-control" type="text" id="mapsearch" size="50" placeholder="cari lokasi anda" style="margin-bottom: 10px; ">
            <div id="map"></div>
